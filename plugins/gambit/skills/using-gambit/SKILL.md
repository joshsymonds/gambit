...
Gambit provides structured development workflows using Gambit's durable Codex task store. This skill loads at session start and routes work to the correct skill.
