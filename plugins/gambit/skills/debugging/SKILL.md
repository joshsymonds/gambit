...
- **Search for context** — `WebSearch` for error messages; dispatch an `explorer` agent for codebase investigation (how is this called? what data flows here? what changed?)
...
**This skill calls:**
- `explorer` / `default` agents for codebase investigation
