...
Answer three questions before writing anything: what does Codex do wrong without this skill, what
...
Then write the RED/GREEN outcome into `codex-contracts/VALIDATION.md`: what behavior flipped, at which
