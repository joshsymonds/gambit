...
Read this reference completely whenever `codex-contracts/executors.md` resolves the Claude
...
`codex-contracts/async-dispatch.md`; never call an MCP tool synchronously in the orchestrator context.
